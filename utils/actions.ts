...
export const generateTourResponse = async ({ city, country }: TourResponse) => {
...
export const getExistingTour = async ({ city, country }: TourResponse) => {
...
export const generateTourImage = async ({ city, country }: TourResponse) => {
  try {
